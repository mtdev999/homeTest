...
static float const kMTCyclerValueWeight = 82.f;
static float const kMTCyclerValueHeight = 187.f;

static float const kMTRunnerValueWeight = 78.f;
static float const kMTRunnerValueHeight = 183.f;
